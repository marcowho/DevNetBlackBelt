...
for cars_detail in cars["sportsCars"]:
    print("Make is " + cars_detail["Make"] + " Model is " +  cars_detail["Model"])
...
### Write loop here to parse and print data
for spark_r in spark_rooms["items"]:
 #   print("Make is " + cars_detail["Make"] + " Model is " +  cars_detail["Model"])
    print("Room is " + spark_r["title"])
...
for spark_r in spark_rooms["items"]:
 #   print("Make is " + cars_detail["Make"] + " Model is " +  cars_detail["Model"])
    print("Room is " + spark_r["title"])
    print("ID is " + spark_r["id"])
    print("Is locked " + spark_r["isLocked"])

for room in spark_rooms["items"]:
    print("Title is: " + room["title"] + ", type is: " + room["isLocked"])
