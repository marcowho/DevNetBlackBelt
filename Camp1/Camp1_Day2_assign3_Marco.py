...
Write the solution into a function and have it called in your main block for the requested answer.
...
def req(check):
	list_num = []
	for num in numbers[0]['sequence'].split(','):
		if int(num) % 2 == check:
...
def main():
	ans = str(input("Enter: odd or even: "))
	if ans == "odd":
		print("The odd numbers are ", *req(1))
	else:
		print("The even numbers are ", *req(0))
